...
graph TD
    A[Obsidian Vault] -->|Scan & Extract| B(Python Curator Script)
    B -->|Send Context| C[Docker Container: Ollama]
    C -->|Llama 3.2 Vision| B
    B -->|Generate Quiz.md| A
    D[Task Scheduler] -->|Trigger Daily at 06:00| B
